...
3️⃣ Each 3 × 3 sub-box must contain digits 1-9 without duplicates.
...
2️⃣ Convert the character to an index:

    digit = board[r][c] - '1'

3️⃣ Compute the box number:

    box = (r / 3) * 3 + (c / 3)

4️⃣ If the digit already exists in:
